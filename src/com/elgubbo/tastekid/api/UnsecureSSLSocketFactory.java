...
public class UnsecureSSLSocketFactory implements SocketFactory,
	...
	private static SSLContext createEasySSLContext() throws IOException {
		try {
			...
			context.init(null,
					new TrustManager[] { new UnsecureX509TrustManager(null) },
					null);
			return context;
		} catch (Exception e) {
	...
	/**
	 * javadoc in org.apache.http.conn.scheme.SocketFactory says : Both
	 * Object.equals() and Object.hashCode() must be overridden for the correct
	 * operation of some connection managers
	 */
	@Override
